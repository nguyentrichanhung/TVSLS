...
from src.AI.utils.google_utils import gsutil_getsize
from src.AI.utils.metrics import fitness
from src.AI.utils.torch_utils import init_torch_seeds
...
def bbox_iou(box1, box2, x1y1x2y2=True, GIoU=False, DIoU=False, CIoU=False, CDIoU=False, eps=1e-7):
    ...
    iou = inter / union
    if GIoU or DIoU or CIoU or CDIoU:
        ...
        if CIoU or DIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
            ...
            c2 = cw ** 2 + ch ** 2 + eps
            dx_12 = (b1_x1-b2_x1) ** 2
            dx_22 = (b1_x1-b2_x1+w1-w2) ** 2
            dy_12 = (b1_y1-b2_y1) ** 2
            dy_22 = (b1_y1-b2_y1+h1-h2) ** 2

            diou = (dx_12 + dx_22 + dy_12 + dy_22)/ (4 * c2) 
